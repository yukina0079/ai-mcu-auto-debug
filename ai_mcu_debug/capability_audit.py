...
CAPABILITIES: tuple[dict[str, Any], ...] = (
    ...
    {
        "id": "signal_observation",
        "phase": "phase1_5",
        "description": "Collect UART/serial runtime evidence as an optional non-vision instrument.",
        "cli": {"runtime-log", "serial-log"},
        "api": {"collect_runtime_log", "collect_serial_log"},
        "mcp": {"collect_runtime_log", "collect_serial_log"},
        "tests": {"tests/test_build_loop.py", "tests/test_serial_log.py"},
        "docs": {"serial-log", "UART observation", "collect_serial_log"},
    },
    {
        "id": "knowledge_guard",
        "phase": "phase2",
    ...
    },
    {
        "id": "skill_deployment",
        "phase": "phase4",
        "description": "Install/update the skill, generate generic AI client MCP wiring, smoke-test the server, and run bootstrap gates.",
        "cli": {"install-skill", "mcp-config", "mcp-smoke", "skill-bootstrap", "agent-bootstrap"},
        "api": {"install_skill_package", "generate_mcp_client_config", "smoke_test_mcp_server", "bootstrap_skill", "bootstrap_agent"},
        "mcp": {"install_skill", "mcp_config", "mcp_smoke", "skill_bootstrap", "agent_bootstrap"},
        "tests": {"tests/test_skill_install.py", "tests/test_mcp_config.py", "tests/test_mcp_smoke.py", "tests/test_skill_bootstrap.py", "tests/test_agent_bootstrap.py"},
        "docs": {"install-skill", "mcp-config", "mcp-smoke", "skill-bootstrap", "agent-bootstrap", "mcu-auto-debug"},
    },
    {
        "id": "safety_policy",
        "phase": "cross_cutting",
